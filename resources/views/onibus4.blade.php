          ...
          <div class="card-body">
            <div class="row">  
              ...
              <div class="col-md-6 col-sm-12">
                <h3>Rota:</h3>
                <ul class="list-group">
                  <li class="list-group-item">A-R. Gen. Osório, 3650 - Hermany, Ibirubá - RS, 98200-000, Brasil</li>
                  <li class="list-group-item">B-APAE-Associação de Pais e Amigos dos Excepcionais - Rua Horizonte - Ltm Por Do Sol, Ibirubá - RS</li>
                  <li class="list-group-item">C-Av. Brasil, 2837 - Hermany, Ibirubá - RS, 98200-000, Brasil</li>
                  <li class="list-group-item">D-Agronomia - IFRS Ibirubá - Rua Nelsi Ribas Fritsch - Esperança, Ibirubá - RS</li>   
                </ul>
              </div>
            </div>
          </div>
