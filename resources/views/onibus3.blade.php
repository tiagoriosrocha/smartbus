    ...
    <div id="accordion">
      ...
      <div class="card semborda fundo margin-normal">
        <div class="card-header fundo semborda" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <h5 class="mb-0">
          <p class="h4 letra">Cassio volta:</p>
          </h5>
        </div>
          ...
          <div class="card-body">
            <div class="row">  
              ...
              <div class="col-md-6 col-sm-12">
                <iframe src="https://www.google.com/maps/d/embed?mid=1iCDLY7OQvM4EfRyrsLpqaN2AXOUtQnw&ehbc=2E312F" width="100%" height="480"></iframe> 
              </div>
              <div class="col-md-6 col-sm-12">
                <h3>Rota:</h3>
                <ul class="list-group">
                  <li class="list-group-item">A-IFRS - Rua Nelsi Ribas Fritsch - Esperança, Ibirubá - RS</li>
                  <li class="list-group-item">B-Clube Campestre Colibri - Rua São Paulo - São Jacó, Ibirubá - RS</li>
                  <li class="list-group-item">C-R. Gen. Osório, 801 - Centro, Ibirubá - RS, 98200-000, Brasil</li>
                  <li class="list-group-item">D-R. Henrique Roetger, 847 - Centro, Ibirubá - RS, 98200-000, Brasil</li>
                </ul>
              </div>
            </div>
          </div>
